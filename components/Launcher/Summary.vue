...
const refTokenDoc = ref({
  "0": {
    ...
    "distributionRules": {
      ...
      "newTokensDestinationIdentity": "3sL6q6eVCR6y8Ld6Gr14cedhJWNBPmBp3S5VtRcckxzE",
    ...
    "description": "Dash USD (DUSD), an instant settlement, low-fee stablecoin with built-in censorship resistance."
  }
})
</script>
