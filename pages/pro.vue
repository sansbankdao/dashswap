    ...
    <main class="mx-auto max-w-7xl py-12 sm:px-2 sm:py-16 lg:px-4">
        <section class="mx-auto max-w-2xl px-4 lg:max-w-none">
            <div class="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
                <div class="flex flex-col gap-5">
                    <h2 class="text-5xl font-bold tracking-tight text-slate-200">
                    ...
                    <p class="mt-4 text-xl leading-8 tracking-wide text-slate-300">
        ...
        <section class="bg-white py-3 sm:py-4">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="flex flex-col mx-auto mt-8 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-10 lg:mx-0 lg:flex lg:max-w-none">
                    <div class="p-8 sm:p-10 lg:flex-auto">
                        <h3 class="text-2xl font-bold tracking-tight text-slate-200">
...
useHead({
    title: `PRO — DashSwap`,
    meta: [
        { name: 'description', content: `DashSwap makes building your next BIG idea effortless.` }
    ],
})
